        ...
        <div class="col-xl-12 col-lg-10 col-md-12 col-sm-12">
            <div class="bg-white tm-block">
                <div class="row">
                    <div class="col-12">
                        <center>
                            <h2 class="tm-block-title d-inline-block">Maladies</h2>
                        </center>
                        </div>
                    </div>
                            ...
                            <?php
                                ...
                                foreach ($data as $row) {
                                    ...
                                    <tr>
                                            ...
                                            <td>$LibelleMaladie</td>
                                            <td>$ObservationMaladie</td>
                                            
                                            
                                            
                                            <td> 
                                              
                                                <a href='Patient.php?IDMaladie=$IDMaladie'>
                                                <button type='button' class='btn btn-default btn-sm' class='open-button' onclick='openForm()'>
                                                <span class='glyphicon glyphicon-th-list'></span> Ajouter à un patient
                                                </button>
                                                </a>
