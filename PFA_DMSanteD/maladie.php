...
$LibelleMalad="";
    ...
    if(isset($_SESSION['INPE'])){
        ...
        if(isset($_GET['IDP'])){
            ...
            if(isset($_GET['IDMaladie'])){
                ...
                $query="SELECT * FROM maladie where IDMaladie ='$IDMaladie'";
                $data=$conn->query($query);
                $data=$data->fetchAll();
                foreach($data as $row){
                    $LibelleMalad=$row['IDMaladie'];$ObservationMaladie=$row['ObservationMaladie'];
                }
            }
    ...
    if(isset($_POST['submit'])){
       // $NomMedecin=$_POST['NomMedecin'];
        ...
        include("conexionDB.php");
        $query="INSERT INTO patient_maladie values ('$DateMaladie','$IDP','$Maladie')";
        $conn->exec($query);
        header("location:Patient.php");
    }
            ...
            <div class="col-xl-8 col-lg-10 col-md-12 col-sm-12">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                        <center>
                            <h2 class="tm-block-title d-inline-block">Ajouter Maladie</h2>
                        </center>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-10 col-lg-7 col-md-12">
                            ...
                            <div class="input-group mb-4">
                                    <label for="Maladie" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Maladie :</label> 
                                    <!-- php pour selectionner les Maladies -->
                                    <select name="Maladie" id="Maladie" class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" placeholder="<?=$LibelleMalad?>">
                                        <option value=""></option>
                                        <?php
                                              ...
                                              $data=$data->fetchall();
                                                foreach ($data as $row) {
                                                    $IDMaladie=$row['IDMaladie'];$LibelleMaladie=$row['LibelleMaladie'];
                                                    $ObservationMaladie=$row['ObservationMaladie'];
                                    
                                                    echo "
                                                    <option value ='$IDMaladie'> $LibelleMaladie -- $ObservationMaladie</option>
                                ...
                                <div class="input-group mb-3">
                                    <label for="DateMaladie" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Date :
                                    </label>
                                    <input id="DateMaladie" name="DateMaladie" type="date" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" data-large-mode="true" value="<?php echo date("Y-m-d");?>">
                                </div>
