<?php 
    ...
    if(isset($_POST['submit'])){
       // $NomMedecin=$_POST['NomMedecin'];
        ...
        $DateOP=date('Y-m-d', strtotime($_POST['DateOP']));
        $DetailsOP=$_POST['DetailsOP'];
        $OrganeConcerne=$_POST['OrganeConcerne'];
        
        include("conexionDB.php");
        $query="INSERT INTO operation values ('','$DateOP','$LibelleOP','$DetailsOP','$OrganeConcerne','$IDP')";
        $conn->exec($query);
        header("location:Patient.php");
    }
            ...
            <div class="col-xl-8 col-lg-10 col-md-12 col-sm-12">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                        <center>
                            <h2 class="tm-block-title d-inline-block">Nouvelle Opération</h2>
                        </center>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-9 col-lg-7 col-md-12">
                            ...
                            <div class="input-group mb-3">
                                    <label for="LibelleOP" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Libelle Opération :
                                    </label>
                                    <input id="LibelleOP" name="LibelleOP" type="text"  data-parsley-type="" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" >
                            </div>

                            <div class="input-group mb-3">
                                    <label for="OrganeConcerne" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Organe Concerné :
                                    </label>
                                    <input id="OrganeConcerne" name="OrganeConcerne" type="text"  data-parsley-type="" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" >
                            </div>


                            <div class="input-group mb-3">
                                    <label for="DetailsOP" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Détails : </label>
                                    <textarea name="DetailsOP" id="DetailsOP" class="form-control"></textarea>
                                    
                                </div>
                                
                            
                            <div class="input-group mb-3">
                                    <label for="DateOP" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Date 
                                        Opération
                                    </label>
                                    <input id="DateOP" name="DateOP" type="date" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"
                                        data-large-mode="true" value="<?php echo date("Y-m-d");?>">
                            </div>
